    ...
    <>
      <div className="border border-dark-subtle rounded-4 m-5 p-5">
        ...
        <form className="row g-3 mt-3" onSubmit={handlerSubmit}>
          <div className='class="col-md-4"'>
            ...
            <input
              ...
              placeholder="Correo"
            />
            <label className="form-label" htmlFor="cotraseña">
              Cotraseña
            </label>
            <input
              className="form-control rounded-4"
        ...
        <div className="row-2 mt-5">
          <button onClick={loginGoogle} className="btn btn-primary rounded-3">
            Iniciar con Google
          </button>
          <button
            onClick={() => setModalRegister(true)}
            className="btn btn-info ms-5 rounded-3"
          >
            Regitrarse
          </button>
        </div>
